...
use simple_voting_app::{instruction, Candidate, Poll};
...
const PROGRAM_ID: Pubkey = Pubkey::new_from_array(simple_voting_app::ID.to_bytes());

async fn setup() -> (BanksClient, Keypair, Hash) {
    let mut program_test = ProgramTest::new("simple_voting_app", PROGRAM_ID, None);
